...
int sc_main(int argc, char **argv) {
	...
	bus.ports[13] = new PortMapping(opt.matrixMul_start_addr, opt.matrixMul_end_addr);
	bus.ports[14] = new PortMapping(opt.matrixMul2_start_addr, opt.matrixMul2_end_addr);
	...
	PeripheralWriteConnector dma2_connector("SimpleDMA2-Connector");
	dma_connector.isock.bind(bus.tsocks[2]);
	dma2_connector.isock.bind(bus.tsocks[3]);
	...
	bus.isocks[13].bind(matrix_mul.tsock);
	bus.isocks[14].bind(matrix_mul2.tsock);
